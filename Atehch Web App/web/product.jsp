	...
	<body class="body" id="body">
			<div class="navigation-bar" id="nav-bar">
				...
				<ul class="navigation-list">
					 <li><a href="dashbord.html.html"><i class="fa fa-home" aria-hidden="true"></i></a></li>
			...
			<div class="products-area" id="product-area">
				...
				<div class="product-specifications">
					...
					<p>
						...
						<button class="add-to-wishlist" onclick="changeHeart()" ><i class="fa fa-heart" aria-hidden="true" id="heart"></i>
